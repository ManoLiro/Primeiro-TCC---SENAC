...
$sql = "SELECT * FROM ordem_de_serviço";
...
<body>
  <div class="wrapper">
    ...
    <div class="container" style="margin-left:120px">
      <div class="row">
        <div class="col-12">
          <div class="container" style="margin-left:120px"><h1 class="text_inicio">Ordem de Serviço</h1></div>
          <nav class="navbar">
            <a href="add_ordem_servico.php">
      ...
      <table id="example" class="table table-bordered" width="100%">
          <thead>
            <tr>
              <th scope="col">Codigo do serviço</th>
              <th scope="col">Codigo do orçamento</th>
              <th scope="col">Codigo do aparelho</th>
              <th scope="col">Codigo do cliente</th>
              <th scope="col">Codigo do funcionarios</th>
              <th scope="col">Codigo do empresa</th>
          ...
          <tbody>
                ...
                <?php while ($dados = $query->fetch_array()) { ?>
                    <tr>
                        <th scope="row"><?php echo $dados['cod_serviço']; ?></th>
                        ...
                        <th scope="row"><?php echo $dados['cod_funcionarios']; ?></th>
                        <th scope="row"><?php echo $dados['cod_empresa']; ?></th>
                        <th scope="row"><?php echo $dados['Status']; ?></th>
                        <th scope="row"><?php echo $dados['Data_saida']; ?></th>
                        <td>
                        <a href="editar_ordem.php?p=editar&cod_serviço=<?php echo $dados['cod_serviço'];?>">
                        <button class="btn">
                          Editar
                        <i class="fas fa-edit"></i>
                        </button>
                        </a>
                        <a href="deletar_ordem.php?cod_serviço=<?php echo $dados['cod_serviço'];?>">
                        <button class="btn">
                          Excluir
