  ...
  <div class="wrapper">
    ...
    <div id="table" class="container">
      ...
      <nav class="navbar navbar-light bg-light">
        <a href="add_cliente.php"><button id="borda" type="button" class="btn btn-light">
          Adicionar
          ...
          <tbody>
                ...
                <?php while ($dados = $query->fetch_array()) { ?>
                    <tr>
                        ...
                        <th scope="row"><?php echo $dados['CPF']; ?></th>
                        <th scope="row"><?php echo $dados['Telefone']; ?></th>
                        <th scope="row"><?php echo $dados['Endereço']; ?></th>
                        <td>
                        <a href="editar_cliente.php?p=editar&cod_cliente=<?php echo $dados['cod_cliente'];?>">
                        <button class="btn">
                          Editar
                        <i class="fas fa-edit"></i>
                        </button>
                        </a>
                        <a href="deletar_clientes.php?cod_cliente=<?php echo $dados['cod_cliente']; ?>">
                        <button class="btn">
                          Excluir
