...
include "config.php";
$sql = "SELECT * FROM ordem_de_serviço WHERE cod_serviço = $cod_serviço";
      ...
      <div>
        ...
        <div class='row'>
          <div class="col-12" style="margin-bottom: 5%;">
              <div class="box">
                <form action="cod_editar_ordem.php" method="POST">
                  <input type="hidden" name="cod_serviço" value="<?php echo $cod_serviço; ?>">
                  <h4>Informações da Ordem de Serviço</h4>
                  <div class="row">
                    <div class="col-4">
                      <label for="exampleFormControlTextarea1" class="form-label">Cod_Orçamento</label>
                      <input type="number" class="form-control" name="cod_orçamento" id="exampleFormControlInput1" value="<?php echo $dados[1]; ?>">
                    </div>
                     <div class="col-4">
                      <label for="exampleFormControlTextarea1" class="form-label">Cod_Aparelho</label>
                      <input type="number" class="form-control" name="cod_aparelho" id="exampleFormControlInput1" value="<?php echo $dados[2]; ?>">
                    </div>
                    <div class="col-4">
                      <label for="exampleFormControlInput1" class="form-label">Cod_Cliente</label>
                      <input type="number" class="form-control" name="cod_cliente" id="exampleFormControlInput1" value="<?php echo $dados[3]; ?>">
                    </div>
                    <div class="col-4">
                      <label for="exampleFormControlInput1" class="form-label">Cod_Funcionarios</label>
                      <input type="number" class="form-control" name="cod_funcionarios" id="exampleFormControlInput1" value="<?php echo $dados[4]; ?>">
                    </div>
                    <div class="col-4">
                      <label for="exampleFormControlInput1" class="form-label">Cod_Empresa</label>
                      <input type="number" class="form-control" name="cod_empresa" id="exampleFormControlInput1" value="<?php echo $dados[5]; ?>">
                    </div>
                    <div class="col-4">
                      <label for="exampleFormControlInput1" class="form-label">Data saida</label>
                      <input type="date" class="form-control" name="Data_saida" id="exampleFormControlInput1" value="<?php echo $dados[7]; ?>">
                    </div>
                    <div class="col-12">
                      <label for="exampleFormControlTextarea1" class="form-label">Status</label>
                      <input type="text" class="form-control" name="Status" id="exampleFormControlTextarea1" value="<?php echo $dados[6]; ?>">
                    </div>
                    <div class="col-md-12">
